...
class BlockStyles extends Styles {
	...
	protected function make_styles() {
		...
		$tablet_breakpoint = $this->setting->get( 'editor.responsive-breakpoints.tablet', $this->tablet_breakpoint ) . 'px';
		$mobile_breakpoint = $this->setting->get( 'editor.responsive-breakpoints.mobile', $this->mobile_breakpoint ) . 'px';
