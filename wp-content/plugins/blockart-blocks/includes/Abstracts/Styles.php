...
abstract class Styles {
	...
	public function enqueue( $version = false ) {
		...
		$inline = blockart_is_preview() || ! ( $this->setting->get( 'asset-generation.external-file', false ) && file_exists( BLOCKART_UPLOAD_DIR . "/$this->filename" ) );
	...
	protected function get_tablet_breakpoint() {
		return $this->setting->get( 'editor.responsive-breakpoints.tablet', $this->tablet_breakpoint ) . 'px';
	}
	...
	protected function get_mobile_breakpoint() {
		return $this->setting->get( 'editor.responsive-breakpoints.mobile', $this->mobile_breakpoint ) . 'px';
	}
}
